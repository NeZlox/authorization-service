...
AUTH_ACCESS_TOKEN_KEY: str = 'pg_access_token'  # Cookie name for access token      # noqa: S105
AUTH_REFRESH_TOKEN_KEY: str = 'pg_refresh_token'  # Cookie name for refresh token   # noqa: S105
