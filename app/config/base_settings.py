...
class AppSettings:
    ...
    CRON_JOBS_ENABLE: bool = field(default_factory=lambda: str_to_bool(os.getenv('CRON_JOBS_ENABLE')))
    CRON_JOB_IDENTIFIER: str = field(default_factory=lambda: os.getenv('CRON_JOB_IDENTIFIER', 'AUTH_SERVICE_JOBS'))
    ...
    JWT_REFRESH_TOKEN_EXPIRE_DAYS: int = field(default_factory=lambda: int(os.getenv('JWT_REFRESH_TOKEN_EXPIRE_DAYS')))
