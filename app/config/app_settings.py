...
from personal_growth_sdk.authorization.models import *  # noqa: F403
from personal_growth_sdk.authorization.models.base import authorization_metadata as metadata

from app.config.base_settings import get_settings

# Configure registry with project metadata
